...
### FEATURE ENHANCEMENT
  ...
  - azure_rm_cdnprofile:
    - Add support for 'Standard' and 'Premium' Frontdoor options ([#1588](https://github.com/ansible-collections/azure/pull/1588))
    - Add support for identity ([#1621](https://github.com/ansible-collections/azure/pull/1621))
  - azure_rm_cdnprofile: Add fetch for 'identity' ([#1621](https://github.com/ansible-collections/azure/pull/1621))
  ...
  - azure_rm_recoveryservicesvault: Add support for 'idenity' ([#1678](https://github.com/ansible-collections/azure/pull/1678))
  - azure_rm_recoveryservicesvault_info: Add fetch the 'idenity' ([#1678](https://github.com/ansible-collections/azure/pull/1678))
  ...
  - azure_rm_diskencryptionset: Add support for auto_upgrade_file ([#1676](https://github.com/ansible-collections/azure/pull/1676))
  - azure_rm_sqlserver: Add support for 'identity' ([#1626](https://github.com/ansible-collections/azure/pull/1626))
  - azure_rm_sqlserver_info: Add fetch the 'identity' ([#1626](https://github.com/ansible-collections/azure/pull/1626))
  - azure_rm_cosmosdbaccount: Add support for 'identity' ([#1645](https://github.com/ansible-collections/azure/pull/1645))
  - azure_rm_cosmosdbaccount_info: Add fetch the 'identity' ([#1645](https://github.com/ansible-collections/azure/pull/1645))
  - azure_rm_functionapp: Add support for 'identity' ([#1690](https://github.com/ansible-collections/azure/pull/1645))
...
### BUG FIXING
  ...
  - azure_rm_networkinterface:
    - Set parimary key when the ip_configuration length is greater than 2 ([#1679](https://github.com/ansible-collections/azure/pull/1679))
    - Support to create secondary IP for NIC using azure_rm_networkinterface ([#1686](https://github.com/ansible-collections/azure/pull/1686))
  - azure_rm_loadbalancer: Fixed load balancing idempotent failure ([#1688](https://github.com/ansible-collections/azure/pull/1688))
  - azure_rm_cdnprofile: Fixed a bug where identity was None and could not be dictionarized ([#1689](https://github.com/ansible-collections/azure/pull/1689))
  - azure_rm_cdnprofile_info: Fixed a bug where identity was None and could not be dictionarized ([#1689](https://github.com/ansible-collections/azure/pull/1689))
  - azure_rm_diskencryptionset_info: Fixed a bug where identity was None and could not be dictionarized ([#1689](https://github.com/ansible-collections/azure/pull/1689))
